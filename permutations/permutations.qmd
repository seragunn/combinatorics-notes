...
Note: in some sources (e.g. books, software), compositions are witten as a product in the reverse order. Sometimes there is an option provided to reverse the multiplication order. Here are those computations in the [SageMath](https://sagecell.sagemath.org/) computer algebra system.
