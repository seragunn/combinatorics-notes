...
\begin{align*}
&1 - \sum_i \frac{1}{p_i} + \sum_{i < j} \frac{1}{p_ip_j} - \cdots \\
&\qquad = 1 - \frac1{p_1} - \sum_{1 < i} \frac{1}{p_i} - \frac1{p_1} \sum_{1 < j} \frac{1}{p_j} + \sum_{1 < i < j} \frac1{p_ip_j} - \cdots \\
&\qquad = \left(1 - \frac1{p_1}\right) - \left(\sum_{1 < i} \frac{1}{p_i} - \frac1{p_1} \sum_{1 < j} \frac{1}{p_j}\right) + \left(\sum_{1 < i < j} \frac1{p_ip_j} - \frac1{p_1} \sum_{1 < i < j} \frac1{p_ip_j} \right) - \cdots \\
