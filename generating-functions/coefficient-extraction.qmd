...
For those of you who have taken computer science or mathematical linguistics, there is a concept known as a "regular language"---languages which can be parsed by a regular expresion. For these regular languages, we will see later on, that they always yeild a *rational* generating function. Here we have a non-rational generating function and indeed this language of strings with equal numbers of $0$s and $1$s is not a regular language.
[We'll define many of these terms in a later section for those of you who haven't seen them before.]{.aside}
