...
<input type="button" id="geo-randomize" value="Randomize" onclick="fillRandomGeo('geo-text', 6, 6)">
Fill in the blank:
...
<input type="button" id="seq-randomize" value="Randomize" onclick="fillRandomSeq('seq-text', 6, 3, 6, 3)">
